    ...
    for batch in train_dataloader:
        ...
        if total_num_batch % valid_steps == 0 and total_num_batch != 0:
            ...
            if fallacy_F > best_fallacy_F_dev:
                torch.save(model.state_dict(), "./saved_models/llama_identify_structure.ckpt")
...
model.load_state_dict(torch.load("./saved_models/llama_identify_structure.ckpt", map_location=device))
